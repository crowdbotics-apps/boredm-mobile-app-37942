...
## Project Structure
    ...
    ├── boredm_mobile_app_37942  # Django project configurations
...
1. Clone this repo and `cd boredm_mobile_app_37942`
...
2. Clone this repo and `cd boredm_mobile_app_37942`
